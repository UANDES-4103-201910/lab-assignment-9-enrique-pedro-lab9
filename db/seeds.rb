...
user_4 = User.create(name: 'Admin', last_name: 'istrator', email: 'admin@admin.com', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', admin: 't')
